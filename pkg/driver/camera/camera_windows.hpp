...
inline imageProp *getProp(camera *cam, int i) { return &cam->props[i]; }

inline char *getName(cameraList *list, int i) { return list->name[i]; }

inline char *getFriendlyName(cameraList *list, int i) { return list->friendlyName[i]; }

inline char *getDescription(cameraList *list, int i) { return list->description[i]; }

inline char *getDevicePath(cameraList *list, int i) { return list->devicePath[i]; }
